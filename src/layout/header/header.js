                ...
                <div className="header_left">
                    ...
                    <div className="header_input">
                        ...
                        fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M32 32L24.9168 24.9042M28.8421 15.4211C28.8421 18.9805 27.4281 22.3942 24.9112 24.9112C22.3942 27.4281 18.9805 28.8421 15.4211 28.8421C11.8616 28.8421 8.44787 27.4281 5.93094 24.9112C3.414 22.3942 2 18.9805 2 15.4211C2 11.8616 3.414 8.44787 5.93094 5.93094C8.44787 3.414 11.8616 2 15.4211 2C18.9805 2 22.3942 3.414 24.9112 5.93094C27.4281 8.44787 28.8421 11.8616 28.8421 15.4211V15.4211Z" 
                            stroke="#AAAAAA" strokeWidth="3" strokeLinecap="round"/>
                        </svg>
