                    ...
                    <div className="progress">
                        <div className="progress_tree">
                            <div className="progression">
                                ...
                                {Progress.length >= 1 &&
                                    <div className="progress_info">1 out of 4</div>
                                }
                            </div>
                            <div className="threads" style={{backgroundColor: "#6198DE"}}></div>
                        </div>
                        <div className="progress_tree">
                            <div className="progression">
                                ...
                                {Progress.length >= 2 &&
                                    <div className="progress_info">2 out of 4</div>
                                }
                            </div>
                            <div className="threads" style={{backgroundColor: "#6198DE"}}></div>
                        </div>
                        <div className="progress_tree">
                            <div className="progression">
                                ...
                                {Progress.length >= 3 &&
                                    <div className="progress_info">3 out of 4</div>
                                }
                            </div>
                            <div className="threads" style={{backgroundColor: "#6198DE"}}></div>
                        </div>
                        <div className="progress_tree">
                            <div className="progression">
                                ...
                                {Progress.length >= 4 &&
                                    <div className="progress_info">4 out of 4</div>
                                }
                            </div>
                        </div>
                    </div> 
